...
pagos= CuponV2_Pagos_to_dataframes(pagosCol.find({'forFree': {"$exists":False}},{'user_id':1,'producto_id':1,'monto':1,'fecha_fin':1,'fecha_pago':1,'pasarela':1,'transaccion_id':1}), 10000)
